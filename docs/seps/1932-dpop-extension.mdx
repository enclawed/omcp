...
sidebarTitle: "SEP-1932: DPoP Profile for MCP"
description: "DPoP Profile for MCP"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 1932                                                                            |
| **Title**     | DPoP Profile for MCP                                                            |
| **Status**    | Accepted                                                                        |
| **Type**      | Standards Track                                                                 |
| **Created**   | 2025-12-05                                                                      |
| **Accepted**  | 2026-09-25                                                                      |
| **Author(s)** | Pieter Kasselman                                                                |
| **PR**        | [#1932](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/1932) |
