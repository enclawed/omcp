---
title: "SEP-2632: Structured Content for Progress Notifications"
sidebarTitle: "SEP-2632: Structured Content for Progress Notific…"
description: "Structured Content for Progress Notifications"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 2632                                                                            |
| **Title**     | Structured Content for Progress Notifications                                   |
| **Status**    | Accepted                                                                        |
| **Type**      | Standards Track                                                                 |
| **Created**   | 2026-04-22                                                                      |
| **Accepted**  | 2026-09-25                                                                      |
| **Author(s)** | [@stevehaertel](https://github.com/stevehaertel) - Steve Haertel                |
| **PR**        | [#2632](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2632) |
