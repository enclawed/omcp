...
6. Added support for [URL mode elicitation](/specification/2025-11-25/client/elicitation#url-mode-elicitation-requests) ([SEP-1036](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/887))
...
4. Updated the [Security Best Practices guidance](https://openmodelcontextprotocol.org/specification/draft/basic/security_best_practices).
