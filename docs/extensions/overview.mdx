...
To get started building MCP Apps, see the [quickstart guide](/extensions/apps/build#getting-started) or read the full [MCP Apps documentation](https://apps.extensions.openmodelcontextprotocol.org/api/documents/Quickstart.html).
...
Experimental extensions provide an incubation pathway for contributors to prototype ideas and collaborate on extension concepts before submitting a proposal.
...
- Experimental extension repositories are kept in the open, and inactive ones may be archived
...
3. **Review**: The proposal is reviewed in its pull request, in the open, on technical merit.
