...
For comprehensive API documentation, advanced patterns, and the full specification, visit the [official MCP Apps documentation](https://apps.extensions.openmodelcontextprotocol.org).
...
2. **Build on AppBridge**: The SDK includes an
   [**App Bridge**](https://apps.extensions.openmodelcontextprotocol.org/api/modules/app-bridge.html)
...
See the [API documentation](https://apps.extensions.openmodelcontextprotocol.org/api/)
