...
The base URL for the MCP Registry REST API is `https://registry.openmodelcontextprotocol.org`. It supports the following endpoints:

- [`GET /v0.1/servers`](https://registry.openmodelcontextprotocol.org/docs#/operations/list-servers-v0.1) — List all servers.
- [`GET /v0.1/servers/{serverName}/versions`](https://registry.openmodelcontextprotocol.org/docs#/operations/get-server-versions-v0.1) — List all versions of a server.
- [`GET /v0.1/servers/{serverName}/versions/{version}`](https://registry.openmodelcontextprotocol.org/docs#/operations/get-server-version-v0.1) — Get a specific version of a server. Use the special version `latest` to get the latest version of the server.
...
```bash
curl "https://registry.openmodelcontextprotocol.org/v0.1/servers?limit=100"
```
...
```bash
curl "https://registry.openmodelcontextprotocol.org/v0.1/servers?limit=100&cursor=com.example/my-server:1.0.0"
```
...
```bash
curl "https://registry.openmodelcontextprotocol.org/v0.1/servers?updated_since=2025-10-23T00:00:00.000Z"
```
...
{
  "$schema": "https://static.openmodelcontextprotocol.org/schemas/2025-12-11/server.schema.json",
