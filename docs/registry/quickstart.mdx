...
```text Output
Publishing to https://registry.openmodelcontextprotocol.org...
...
```bash
curl "https://registry.openmodelcontextprotocol.org/v0.1/servers?search=io.github.my-username/weather"
```
