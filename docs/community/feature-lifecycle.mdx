...
- or another reason stated explicitly in the deprecation proposal.

Deprecation is a specification change and therefore requires a proposal per the
[proposal guidelines](/community/sep-guidelines). The deprecation proposal must:
...
1. Once a feature is set for removal, the removal is executed after the minimum
...
Shortening the window must be justified in the open, with the advisory or the
evidence of exploitation cited, and recorded in the deprecation proposal or,
where the risk surfaces after that proposal is already Final, in a short
expedited-removal proposal that references it. The shortened
...
| Action                                         | Who                                                                   |
| ---------------------------------------------- | --------------------------------------------------------------------- |
| Propose deprecation, extension, or restoration | Any contributor, as a pull request                                    |
| State the case                                 | The author, in the proposal                                           |
| Review the proposal                            | Anyone, in the open, on technical merit                               |
| Decide a removal during release preparation    | Decided in the open, with the reasoning recorded in the release notes |
| Ship the migration path                        | The author, alongside the change                                      |

Every decision here is made in a pull request thread and stays readable there
afterwards. A deprecation that cannot be justified in writing does not happen.
