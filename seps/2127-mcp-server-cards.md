...
> **Imported from upstream.** Proposed as [modelcontextprotocol#2127](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2127)
> by @dsp-ant on 2026-01-21, where it was still open on 2026-09-25.
...
>
> **Reviewed 2026-09-25 — accepted.** The document carries every required section, and a prototype a reviewer can run is cited at https://github.com/modelcontextprotocol/experimental-ext-server-card. Conformance tests and the reference documentation chapter are still required before Final.
