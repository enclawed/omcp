...
- Drive proposals through the [SEP](https://omcp.tech/community/sep-guidelines) (Specification Enhancement Proposal) process to resolution
...
1. `docs/community/working-interest-groups.mdx` — governance rules (Part 1) published as the Working and Interest Groups page on omcp.tech
