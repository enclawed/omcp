...
10. **MCP Server Access**: The MCP client makes a JSON-RPC request to the MCP
    ...
    in the baseline [MCP Authorization](https://omcp.tech/specification/draft/basic/authorization) specification.

11. **Validate Access Token**: The MCP server validates the access token according to
    the baseline [MCP Authorization](https://omcp.tech/specification/draft/basic/authorization) specification, including
...
- The baseline [MCP Authorization](https://omcp.tech/specification/draft/basic/authorization) security requirements.
