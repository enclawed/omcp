...
> **Imported from upstream.** Proposed as [modelcontextprotocol#1933](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/1933)
> by @PieterKas on 2025-12-05, where it was still open on 2026-09-25.
...
10. **MCP Server Access**: The MCP client makes a JSON-RPC request to the MCP
    ...
    in the baseline [MCP Authorization](https://openmodelcontextprotocol.org/specification/draft/basic/authorization) specification.

11. **Validate Access Token**: The MCP server validates the access token according to
    the baseline [MCP Authorization](https://openmodelcontextprotocol.org/specification/draft/basic/authorization) specification, including
...
- The baseline [MCP Authorization](https://openmodelcontextprotocol.org/specification/draft/basic/authorization) security requirements.
