...
> **Imported from upstream.** Proposed as [modelcontextprotocol#2692](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2692)
> by @nickcoai on 2026-05-06, where it was still open on 2026-09-25.
...
>
> **Reviewed 2026-09-25 — not yet accepted.** Held as a draft because no prototype a reviewer can run is cited, and there is no Security Implications section. Acceptance needs a prototype a reviewer can run, with its setup and the data to run it; Final also needs conformance tests and the reference documentation chapter.
