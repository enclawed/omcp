...
The [tool errors specification](https://openmodelcontextprotocol.org/specification/2025-06-18/server/tools#error-handling) currently provides ambiguous guidance:
...
- [MCP Tools Error Handling Specification](https://openmodelcontextprotocol.org/specification/2025-06-18/server/tools#error-handling)
