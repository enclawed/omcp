...
> **Imported from upstream.** Proposed as [modelcontextprotocol#2793](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2793)
...
- Tool authors have no standard place to declare _intended_ risk — the
...
`destructiveHint` _almost_ fills this gap but is binary: a tool that
...
concern (UI, identity, audit). The spec offers a _recommendation_ the
