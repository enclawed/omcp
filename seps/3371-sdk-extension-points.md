...
The extension points become a Tier 1 requirement. Rollout is agreed separately through SDK governance, with the SDK guidance and [tiering documentation](https://omcp.tech/community/sdk-tiers) updated accordingly.
...
This assessment uses the revisions linked below, reviewed on 2026-09-18. Tier labels follow the [official SDK listing](https://omcp.tech/docs/2026-07-28/sdk) used at that time.
