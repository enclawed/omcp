...
> **Imported from upstream.** Proposed as [modelcontextprotocol#3371](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/3371)
> by @sambhav on 2026-09-18, where it was still open on 2026-09-25.
...
The extension points become a Tier 1 requirement. Rollout is agreed separately through SDK governance, with the SDK guidance and [tiering documentation](https://openmodelcontextprotocol.org/community/sdk-tiers) updated accordingly.
...
This assessment uses the revisions linked below, reviewed on 2026-09-18. Tier labels follow the [official SDK listing](https://openmodelcontextprotocol.org/docs/2026-07-28/sdk) used at that time.
